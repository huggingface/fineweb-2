...
SlurmPipelineExecutor(
    job_name="dl_arabicweb24",
    pipeline=[
        ArrowReader("hf://datasets/lightonai/ArabicWeb24", glob_pattern="ArabicWeb24/**/*.arrow", default_metadata={"language": "ar"}),
        JsonlWriter("s3://path/ref-datasets/monolingual/ar/arabicweb24", output_filename="${rank}.jsonl.gz", max_file_size=2*2**30)
    ],
    tasks=32,
    logging_dir="/path/to/logs/dataset_download_logs/ar/arabicweb24",
